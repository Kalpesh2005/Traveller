...
This frontend reads `REACT_APP_API_URL` at build time. If not provided it defaults to `https://traveller-17ng.onrender.com`.

To run against a local backend, create a `.env` file in `frontend/` with:
